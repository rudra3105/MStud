...
<?php 	
				...
				//	$result = mysqli_query($con,"SELECT * FROM reg where Councellor_name = 'Prof. x'  ORDER BY sem,enrollment_number") or die('Error');
                    ...
                    while($row = mysqli_fetch_array($result)) {
						...
						echo '<tr><td><center>'.$c++.'</center></td><td><center>'.$sem.'</center></td><td><center>'.$cn.'</center></td><td><center>'.$CB.'</center></td><td><center><a href="View_data?id='.$title.'">'.$title.'</a></center></td><td><center>'.$name.'</center></td><td><center>'.$contact1.'</center></td><td><center>'.$fees_status.'</center></td><td><center>'.$Account_status.'</center></td><td><center>'.$hos_status.'</center></td><td><center>'.$hos_name.'</center></td><td><center>'.$room.'</center></td><td><center>'.$lib_status.'</center></td><td><center>'.$Rstatus.'</center></td><td><center>'.$Svalid.'</center></td></tr>';
